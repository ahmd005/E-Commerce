...
class OrderController extends Controller
{
    ...
    public function bootstrapStock(Request $request)
    {
        ...
        if ($productId) {
            if (Product::find($productId)) {
                Product::whereKey($productId)->update([
                    'name' => $validated['name'] ?? 'Stress Test Product',
                    'description' => $validated['description'] ?? 'Bootstrap product for concurrency testing',
        ...
        return response()->json([
            'message' => 'Product bootstrapped successfully',
